...
public class DateAPIDemo {
    ...
    public static void main(String[] args) {
        System.out.println("Clock Test:");
        clockTest();
        System.out.println("ZoneId Test:");
        zoneIdTest();
    ...
    public static  void clockTest(){
        ...
        System.out.println("clock mills: "+millis);//1552379579043
        Instant instant = clock.instant();
        System.out.println("instant: "+instant);
        Date legacyDate = Date.from(instant); //2019-03-12T08:46:42.588Z
        System.out.println("date: "+legacyDate);//Tue Mar 12 16:32:59 CST 2019
    }

    public static void zoneIdTest(){
        //输出所有区域标识符
        System.out.println("all time zone tag: "+ZoneId.getAvailableZoneIds());
